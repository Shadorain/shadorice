...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        subscriptions.push(coc_nvim_1.commands.registerCommand('todolist.browserOpenGist', () => __awaiter(this, void 0, void 0, function* () {
            const userName = yield info.fetch('userName');
            const gistId = yield info.fetch('gistId');
            if (userName && gistId) {
                const url = `https://gist.github.com/${userName}/${gistId}`;
                nvim.call('coc#util#open_url', url, true);
            }
            else {
                coc_nvim_1.workspace.showMessage('userName or gistId not found', 'error');
            }
        })));
    ...
    download(directory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (res.status == 200 && res.responseText) {
                ...
                yield this.info.push('userName', gist.owner.login);
            }
