...
" Generated by http://bytefluent.com/vivify 2020-05-02
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Title guifg=#8897F4 guibg=NONE guisp=NONE gui=NONE ctermfg=39 ctermbg=NONE cterm=NONE "#00bbff
...
hi DiffDelete guifg=#d1c5ce guibg=#c9083f guisp=#c9083f gui=NONE ctermfg=252 ctermbg=1 cterm=NONE
...
hi DiffChange guifg=#dacdde guibg=#2f77a1 guisp=#2f77a1 gui=NONE ctermfg=253 ctermbg=67 cterm=NONE
...
hi DiffAdd guifg=#221d26 guibg=#2c9465 guisp=#2c9465 gui=NONE ctermfg=235 ctermbg=29 cterm=NONE
